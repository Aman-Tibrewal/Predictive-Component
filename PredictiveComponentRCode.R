...
DataSkewnessRedacted <- EmployeeData_Redacted %>% 
  summarise(skewness(EmployeeData_Redacted$satisfaction_level),
            skewness(EmployeeData_Redacted$last_evaluation),
            skewness(EmployeeData_Redacted$number_project),
            skewness(EmployeeData_Redacted$average_montly_hours),
            skewness(EmployeeData_Redacted$time_spend_company),
            skewness(EmployeeData_Redacted$Log_TimeSpent),
            skewness(EmployeeData_Redacted$Inv_TimeSpent))
DataKurtosisRedacted <- EmployeeData_Redacted %>% 
  summarise(kurtosis(EmployeeData_Redacted$satisfaction_level),
            kurtosis(EmployeeData_Redacted$last_evaluation),
            kurtosis(EmployeeData_Redacted$number_project),
            kurtosis(EmployeeData_Redacted$average_montly_hours),
            kurtosis(EmployeeData_Redacted$time_spend_company),
            kurtosis(EmployeeData_Redacted$Log_TimeSpent),
            kurtosis(EmployeeData_Redacted$Inv_TimeSpent))
...
boxplot(EmployeeData_Redacted$time_spend_company, main="EmployeeData_Redacted$time_spend_company")
...
#Continuous Variables
VariableMatrixRedacted <- cbind(EmployeeData_Redacted[,c(1:5,13)],EmployeeData_Redacted$Inv_TimeSpent)
...
#Categorical Variables
#2 category variables
LeveneTest(EmployeeData_Redacted$average_montly_hours,
           as.factor(Work_accident),
           center = mean)        #p=0.000151(<0.05),F=14.369
t.test(EmployeeData_Redacted$average_montly_hours~EmployeeData_Redacted$Work_accident,
       var.equal=T)             #p=0.4348(>0.05),T=0.78101

LeveneTest(EmployeeData_Redacted$average_montly_hours,
           as.factor(left),
           center = mean)       #p=2.2e-16(<0.05),F=1230.1
t.test(EmployeeData_Redacted$average_montly_hours~EmployeeData_Redacted$left,
       var.equal=T)             #p=5.185e-09(<0.05),T=-5.84557

LeveneTest(EmployeeData_Redacted$average_montly_hours,
           as.factor(promotion_last_5years),
           center = mean)       #p=0.5717(>0.05),F=0.3199
t.test(EmployeeData_Redacted$average_montly_hours~promotion_last_5years,
...
welch_anova_test(data = EmployeeData_Redacted,
                 EmployeeData_Redacted$average_montly_hours~Dept_Convert)   #p=0.909(>0.05),F=0.45

LeveneTest(EmployeeData_Redacted$average_montly_hours,
           as.factor(Salary_Convert),
           center = mean)       #p=0.01421(<0.05),F=4.2554
aov_salaryRedacted <- aov(EmployeeData_Redacted$average_montly_hours~ EmployeeData_Redacted$Salary_Convert)
...
Model4 <- lm(EmployeeData_Redacted$average_montly_hours ~
               EmployeeData_Redacted$last_evaluation +
               EmployeeData_Redacted$number_project +
               EmployeeData_Redacted$left +
               EmployeeData_Redacted$time_spend_company)
summary(Model4)
...
#Variables Taken: DV: Average_Monthly_Hours;
#IV: Last_Evaluation, Number_Projects, Left
Model5 <- lm(EmployeeData_Redacted$average_montly_hours ~ 
               EmployeeData_Redacted$last_evaluation +
               EmployeeData_Redacted$number_project +
               EmployeeData_Redacted$left)
summary(Model5)
...
Model6 <- lm(EmployeeData_Redacted$average_montly_hours ~ 
               EmployeeData_Redacted$last_evaluation +
               EmployeeData_Redacted$number_project +
               EmployeeData_Redacted$left+
               EmployeeData_Redacted$Log_TimeSpent)
summary(Model6)
...
Model7 <- lm(EmployeeData_Redacted$average_montly_hours ~ 
               EmployeeData_Redacted$last_evaluation +
               EmployeeData_Redacted$number_project +
               EmployeeData_Redacted$left+
               EmployeeData_Redacted$Inv_TimeSpent)
summary(Model7)